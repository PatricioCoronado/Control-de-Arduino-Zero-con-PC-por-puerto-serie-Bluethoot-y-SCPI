...
*/
char IdentidadDelSistema[] ="Pruebas bluetooth con HC-06";   
//------------------------------------------------------------------------------------------
// Ficheros include                                                          
//------------------------------------------------------------------------------------------
#include <ansi_c.h>
 ...
 int main (int argc, char *argv[])
{
	...
	else 
	{
		...
		// Corre la aplicación........................................................
	SetCtrlAttribute (PrincipalHandle, PRINCIPAL_TIMER, ATTR_ENABLED, 0);	
	RunUserInterface (); 
		...
		int panel)
{
	...
	MessagePopup 
	   ("   Autor: ", "         Patricio Coronado Collado\n"
		...
		"Solo tiene autorización para utilizar este software\n"
		"su autor.\n"
		...
		void *callbackData, int eventData1, int eventData2)
{
	...
	if(event==EVENT_COMMIT)       
	{
		...
		SetCtrlVal(panel,PRINCIPAL_SISTEMA,"");	 
...
/****************************************************************************************
 							ARRANCA O PARA EL TIMER
*****************************************************************************************/
int CVICALLBACK iniciar_test (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	static EstadoTest=0;
	switch (event)
	{
		case EVENT_COMMIT:
			switch(EstadoTest)
			{
				...
				// Arranca el timer
					EstadoTest=1;
					SetCtrlAttribute (PrincipalHandle, PRINCIPAL_PRINCIPIO_FIN, ATTR_LABEL_TEXT, "Fin");
					SetCtrlAttribute (PrincipalHandle, PRINCIPAL_TIMER, ATTR_ENABLED, 1);
				break;
				case 1:
				// Arranca el timer
					EstadoTest=0;
					SetCtrlAttribute (PrincipalHandle, PRINCIPAL_PRINCIPIO_FIN, ATTR_LABEL_TEXT, "Inicio");					
					SetCtrlAttribute (PrincipalHandle, PRINCIPAL_TIMER, ATTR_ENABLED, 0);
				break;
			}
